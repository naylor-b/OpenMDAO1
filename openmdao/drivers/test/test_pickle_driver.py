...
from openmdao.drivers.pickle_case_driver import PickleCaseDriver, \
                                                save_cases_as_pickle
from openmdao.test.util import ConcurrentTestCaseMixin

class TestPickleDriver(unittest.TestCase, ConcurrentTestCaseMixin):

    def setUp(self):
        self.concurrent_setUp(prefix='test_pickle_drv-')
    ...
    def test_case_driver(self):
        ...
        save_cases_as_pickle(cdriver, "cases.pkl")
        problem.driver = PickleCaseDriver("cases.pkl")
